; Client isntall script WITHOUT old client support
...
Name "${PRODUCT_NAME}"
OutFile "C:\_Greencubes\Git\GreenCubesLauncher\install\GreenCubes-setup-no.exe"
...
Section "MainSection" SEC01
  ...
  inetc::get /RESUME "" /QUESTION $(MUI_TEXT_ABORTWARNING) "https://greencubes.org/client/windows-installer-no.zip" "package.zip"
    Pop $0
    StrCmp $0 "OK" dlok1
    goto error
  dlok1:
