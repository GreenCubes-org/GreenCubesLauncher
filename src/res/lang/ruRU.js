...
"login.autologin.tip": "Хранить пароль на компьютере не абсолютно безопасно. Пароль всё равно может потребоваться при входе.",
"login.dologinoffline": "Оффлайн режим",
"login.nousername": "Введите имя аккаунта",
"login.nousernamepassword": "Введите имя аккаунта и пароль",
"login.nopassword": "Введите пароль",
"login.title": "Вход в GreenCubes",
"login.error.title": "Ошибка",
"login.error.repeat": "Повторить",
"login.error.offline": "Войти оффлайн",
...
"settings.client.running": "Невозможно изменить настройки клиента, когда он запущен. Закройте игру.",
